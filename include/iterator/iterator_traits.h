...
private:
    ...
    static true_type __test(typename _Up::iterator_category* = nullptr,
                            ...
                            typename _Up::value_type* = nullptr,
                            typename _Up::reference* = nullptr,
                            typename _Up::pointer* = nullptr);

public:
    static const bool value = decltype(__test<_Tp>(nullptr, nullptr, nullptr,
...
struct __iterator_traits<Iter, true>
    : __iterator_traits_impl<
          Iter, is_convertible<typename Iter::iterator_category,
                               input_iterator_tag>::value ||
                    is_convertible<typename Iter::iterator_category,
                                   output_iterator_tag>::value> {};

template <class Iter>
struct iterator_traits
    : __iterator_traits<Iter, __has_iterator_typedefs<Iter>::value> {};
